            ...
            {movedItems.length <= 0 &&
              ...
              selectedCategory != null && (
                <div
                  ...
                  className="mr-2 mt-2 flex h-12 w-full cursor-pointer select-none items-center justify-center self-start whitespace-nowrap  rounded-full border border-dashed border-gray-900 bg-zinc-50 px-7 py-2 hover:bg-zinc-50/50  xs:w-fit lg:ml-5 lg:mr-3 lg:mt-0  "
                >
                  Associate
                </div>
              )}
            {movedItems.length > 0 && (
              <div className="flex  justify-evenly  xs:justify-end">
                <div
                  ...
                  className="mx-2 mt-2 flex h-12 w-fit cursor-pointer select-none items-center justify-center  self-start whitespace-nowrap rounded-full border border-dashed border-gray-900  bg-orange-100/15 px-6  py-1 hover:bg-zinc-50/50 lg:mx-0 lg:ml-5 lg:mt-0  "
                >
                  Update
                </div>
                <div
                  ...
                  className="mx-2 mt-2 flex h-12 w-fit cursor-pointer select-none items-center justify-center  self-start whitespace-nowrap rounded-full border border-dashed border-gray-900  bg-orange-100/15  px-6  py-1 hover:bg-zinc-50/50 lg:ml-5 lg:mt-0  "
                >
                  Cancel
                </div>
              </div>
